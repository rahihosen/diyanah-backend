...
<div class="row">
    <div class="col-lg-12">
        <div class="card mb-3">
            <form class="validate1" action="{{route ('features.store') }}" method="post" enctype="multipart/form-data" >
            @csrf
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="input-group col">
                                <input class="form-control" name="feature_title" placeholder="i.e Convenient & Quick" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="input-group col">
                                <textarea  class="form-control" id="editor" name="feature_description" placeholder="i.e Write Text here..." required></textarea>
                            </div>
                        </div>
