...
<div class="row">
    <div class="col-lg-12">
        <div class="card mb-3">
            <form class="validate1" action="{{route ('permissions.store') }}" method="post" enctype="multipart/form-data" >
            @csrf
                    ...
                    <li class="list-group-item">
                        <div class="form-group row">
                            ...
                            <div class="input-group col">
                                <input class="form-control" id="permission_name" name="name" placeholder="product.create"  required>
                            </div>
